...
void read_elf_sections()
{
	...
	for(int c=0;c<snum;c++)
	{
		...
		if(strcmp(header_name,".data")==0){
			data_adr[0]=*(long*)elf64_shdr.sh_offset.b;
                        data_size[0]=*(long*)elf64_shdr.sh_size.b;
                        data_vadr[0]=*(long*)elf64_shdr.sh_addr.b;
		}
		else if(strcmp(header_name,".bss")==0){
			data_adr[1]=*(long*)elf64_shdr.sh_offset.b;
                        data_size[1]=*(long*)elf64_shdr.sh_size.b;
                        data_vadr[1]=*(long*)elf64_shdr.sh_addr.b;
		}
		else if(strcmp(header_name,".sdata")==0){
			data_adr[2]=*(long*)elf64_shdr.sh_offset.b;
                        data_size[2]=*(long*)elf64_shdr.sh_size.b;
                        data_vadr[2]=*(long*)elf64_shdr.sh_addr.b;
		}
		else if(strcmp(header_name,".sbss")==0){
			data_adr[3]=*(long*)elf64_shdr.sh_offset.b;
                        data_size[3]=*(long*)elf64_shdr.sh_size.b;
                        data_vadr[3]=*(long*)elf64_shdr.sh_addr.b;
		}
